...
exports.createExtension = exports.getAltStatusMessage = exports.StatusCodes = exports.TransportStatusError = exports.TransportError = void 0;
...
var Extension = /** @class */ (function () {
    function Extension(web3, extension) {
        var _this = this;
        this.reciver = function (cla, ins, p1, p2, data, statusList) {
            if (data === void 0) { data = Buffer.alloc(0); }
            if (statusList === void 0) { statusList = [errors_1.StatusCodes.OK]; }
            return __awaiter(_this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, new Promise(function (resoleve, reject) {
                            _this.extension.once("receive", function (_a) {
                                var isSuccess = _a.isSuccess, result = _a.result;
                                if (isSuccess) {
                                    resoleve(result);
                                }
                                else {
                            ...
                            _this.web3.emit("send", cla, ins, p1, p2, data, statusList);
                        })];
                });
            });
        };
        this.send = function (cla, ins, p1, p2, data, statusList) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.reciver(cla, ins, p1, p2, data, statusList)];
                        case 1:
                            buffer = _a.sent();
    ...
    Extension.prototype.on = function (eventName, cb) {
        this.web3.emit("on", eventName);
        this.extension.on(eventName, cb);
    };
    // eslint-disable-next-line no-unused-vars
    Extension.prototype.off = function (eventName, cb) {
...
function createExtension(web3, extension) {
